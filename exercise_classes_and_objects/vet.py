...
There should also be 2 class attributes: animals (empty list) which will store the total amount\
of animals for all vets; and space (5 by default). You should create 3 additional instance methods:
